...
class MSControler:
    ...
    def ShowBest(self):
        self.LoadTopScore()
        ev3.screen.draw_line(4, 5, 4 + self.TopScore // 2, 5 , width=3, color=Color.BLACK)
        
    #显示积分
    def ShowScore(self):
        ev3.screen.draw_line(4, 9, 4 + self.ASnake.GetLength() // 2, 9, width=3, color=Color.BLACK)
    ...
    def ShowResult(self):
        ev3.screen.print( 
            "\n\n" +
            "   最高分：" + str(self.TopScore) + "\n\n" +
            "   您的得分：" + str(self.ASnake.GetLength()) + "\n\n\n" +
            "\n" +
            "        按右键继续...") 
